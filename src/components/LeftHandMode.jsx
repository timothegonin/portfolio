...
const LeftHandIcon = styled.svg`
	animation: ${flipVertical} 0.3s cubic-bezier(0.455, 0.03, 0.515, 0.955) both;
`;
const RightHandIcon = styled.svg`
	animation: ${flipVertical} 0.3s cubic-bezier(0.455, 0.03, 0.515, 0.955) both
		reverse;
`;
...
const LeftHandMode = () => {
	...
	const handleUiDirection = () => {
		toogleUiDirection(!leftHandedMode);
	};
	...
	return (
		<Button
			className="d-flex align-items-center justify-content-center p-2 border-2 border-secondary border-opacity-25"
			role="button"
